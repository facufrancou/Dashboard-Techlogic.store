...
function CreateProduct() {
    ...
    return (
        <div>
            ...
            <h2 className="title-edit-create-form">Formulario de Creación</h2>

                {/* FORMULARIO DE CREACIÓN */}
                <form action="/api/products/create" method="POST" encType="multipart/form-data" id="createProduct-form" onSubmit={handleSubmit}>
                    ...
                    <div className="div-edit-create-form">
                        ...
                        <input type="text" id="name" name="name" className="normal-input" placeholder="Ej: Teléfono iPhone 13" onChange={handleInputChange} />
                    </div>
                    ...
                    <div className="div-edit-create-form">
                        ...
                        <input type="number" id="price" name="price" className="normal-input" placeholder="Ej: 12500" onChange={handleInputChange} />
                    </div>

                    {/* INPUT DEL DESCUENTO DEL PRODUCTO */}
                    <div className="div-edit-create-form">
                        <label htmlFor="discount" className="label-normal-input">Descuento del Producto:</label>
                        <input type="number" id="discount" name="discount" className="normal-input" placeholder="Ej: 10" onChange={handleInputChange} />
                    </div>
                    ...
                    <div className="div-edit-create-form">
                        ...
                        <textarea name="description" id="description" className="textarea-edit-create-form" onChange={handleInputChange}></textarea>
                    </div>

                    {/* INPUT DE LA IMAGEN NUEVA DEL PRODUCTO */}
                    <div className="div-edit-create-form">
                        <label htmlFor="image" className="label-normal-input">Imagen del Producto:</label>
                        <input type="file" id="image" name="image" className="normal-input image-input" onChange={handleInputChange} />
                    </div>

                    {/* BOTONES PARA CREAR UN PRODUCTO */}
                    <div className="buttons-edit-create-form">
                        <button type="submit" className="button-cart button-edit-create-form">Crear</button>
                    </div>
